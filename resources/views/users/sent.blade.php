    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-2">
          <div class="list-group" id="list-tab" role="tablist">
            <a class="list-group-item list-group-item-action" id="list-home-list" href="/messages/inbox2" role="tab" aria-controls="home"><i class="fas fa-inbox"></i> Inbox</a>
            <a class="list-group-item list-group-item-action active" id="list-profile-list"  href="/messages/sent" role="tab" aria-controls="profile"><i class="fas fa-share"></i> Sent</a>
            ...
            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                ...
                <div class="media mb-2 messages">
                  ...
                  <div class="media-body">
                    ...
                    <p><i class="fas fa-share"></i> {{$user['lmsg']}}</p>
                    <div style=" 
                    display: flex;
                    flex: 1;
                    flex-direction: row;
