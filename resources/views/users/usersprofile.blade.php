    ...
    <h3>My Photos</h3>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <img loading="lazy" src="{{ $phtopst->pro_pic_path }}" style="object-fit: cover;width: 300px;height: 300px; margin-right: 10px;margin-top: 20px; border-radius: 10px; cursor: pointer; float: left;" alt="">
                        <p style="margin-top: 10px;text-align: center;"><b><a href="/deletephotopost/{{ $phtopst->pro_pic_id }}" style="color:#E9343F;" onclick="return confirm('Are you sure you want to delete this post?');">Delete Photo</a></b></p>
                    </div>
                    @endif
                    @endforeach
                    @endif
