...
<div class="content my-3 my-md-5">
    ...
    <div class="card-header">
        ...
        <div class="card-options">
            <a onclick="search()" href="/photos" class="btn btn-secondary btn-sm">
                <i class="fa fa fe-arrow-left"></i> Back            </a>
        </div>
    </div>
    <div class="card-body">
        
        <form id="w0" action="/uploadpost" method="post" enctype='multipart/form-data'>
            {{ csrf_field() }}
...
<div class="help-block"></div>
        ...
        <p><b>The face must be clear and visible in order <br>for the profile to be approved.</b></p>
    </div>
