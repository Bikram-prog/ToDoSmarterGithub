  ...
  <div>
    <div>
      ...
      <div class="modal-body">
        ...
        <form action="/u/edittodolistaction-smarter" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
        ...
        <div class="form-group mb-2">
          ...
          <input class="form-control" type="text" id="datepicker" name="trgt_job_todo" placeholder="Days to complete job" value="{{ $data[0]->to_do_list_target_days }}" autocomplete="off" required>
        </div>
        ...
        <div class="form-group mb-2">
        <img style='width:200px;' src='http://todosmarter.com/images/to_do_smarter_img/{{ $data[0]->to_do_list_image }}'>
        ...
        <!-- email list -->
        <p style="font-weight: 700; font-size: 16px;">Recipients</p>
        @php
          $reciepent = DB::table('to_do_list_reciepent')->where('reciepent_company_name', '=', Crypt::decryptString($_COOKIE['UsersCompanyToDoSmarter']))->get();
        ...
        <div class="alert alert-danger mt-3">
          This "Edit Project" page is in 2 stages,once you input all info on this page and press next,it will then take you to the File attachment page for posting.
        </div>
