                ...
                <form action="/u/editreciepentpost" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group mb-2">
                        ...
                        <option value="Male" <?php echo ($data[0]->reciepent_gender ? 'selected' : ''); ?>>Male</option>
                        <option value="Female" <?php echo ($data[0]->reciepent_gender ? 'selected' : ''); ?>>Female</option>
                        </select>
                        </div>
                      </div>
                      <div class="col-md-4">
                      ...
                      <input class="form-control" type="text" id="datepicker" name="dob" value="{{ $data[0]->reciepent_dob }}" placeholder="Date Of Birth" autocomplete="off" >
                    </div>
                      </div>
                      <div class="col-md-4">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group mb-2">
                        ...
                        <input class="form-control" type="text" name="pstn_title" value="{{ $data[0]->reciepent_position }}" placeholder="Position Title" autocomplete="off">
                        </div>
                      </div>
                      <div class="col-md-6">
                      <div class="form-group mb-2">
                        <label>Department</label>
                        <input class="form-control" type="text" name="deprtment" value="{{ $data[0]->reciepent_department }}" placeholder="Department" autocomplete="off">
                      </div>
                      </div>
                    </div>
                      ...
                      <div class="form-group mb-2">
                        <label>Address</label>
                        <input class="form-control" type="text" name="address" value="{{ $data[0]->reciepent_address }}" placeholder="Address" autocomplete="off">
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group mb-2">
                        <label>Suburb</label>
                        <input class="form-control" type="text" name="suburb" value="{{ $data[0]->reciepent_suburb }}" placeholder="Suburb" autocomplete="off">
                        </div>
                        </div>
                        ...
                        <div class="form-group mb-2">
                        <label>State</label>
                        <input class="form-control" type="text" name="state" value="{{ $data[0]->reciepent_state }}" placeholder="State" autocomplete="off">
                        </div>
                        </div>
                        ...
                        <input class="form-control" type="number" name="pst_code" value="{{ $data[0]->reciepent_postcode }}" placeholder="Postcode" autocomplete="off">
                        </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <input class="form-control" type="number" name="home_num" value="{{ $data[0]->reciepent_home_phone }}" placeholder="Home Phone Number" autocomplete="off">
                        </div>
                        </div>
                        <div class="col-md-6">
                        <div class="form-group mb-2">
                        <label>Mobile Phone Number</label>
                        <input class="form-control" type="number" name="mob_num" value="{{ $data[0]->reciepent_mob_number }}" placeholder="Mobile Phone Number" autocomplete="off">
                        </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <input class="form-control" type="email" name="email_company" value="{{ $data[0]->reciepent_prsnl_com_email }}" placeholder="Email Address(Company)" autocomplete="off">
                        </div>
                        </div>
                        <div class="col-md-6">
                        <div class="form-group mb-2">
                        <label>Email Address(Personal)</label>
                        <input class="form-control" type="email" name="email_prsnl" value="{{ $data[0]->reciepent_prsnl_email }}" placeholder="Email Address(Personal)" autocomplete="off">
                        </div>
                        </div>
                      </div>
