        ...
        <div class="col-md-8">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Add Company Details</h5>
                
              </div>
              <div class="modal-body">

                <form action="/u/setupcompanypost" method="POST">
                    @csrf

                    <div class="form-group mb-2">
                        <label>Company Email*</label>
                        <input class="form-control" type="email" name="comp_email" autocomplete="off">
                      </div>
              
                      <div class="form-group mb-2">
                        <label>Contact Number*</label>
                        <input class="form-control" type="number" name="comp_number" autocomplete="off">
                      </div>
              
                      <div class="form-group mb-2">
                        <label>Address*</label>
                        <input class="form-control" type="text" name="comp_address" autocomplete="off">
                      </div>
