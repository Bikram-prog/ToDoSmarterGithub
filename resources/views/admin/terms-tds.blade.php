    ...
    <div class="container-fluid terms-header pb-5">
        ...
        <div class="container">
          <div class="row">
           ...
           <div class="row">
            <div class="col-lg-12 mt-5"><p class="title-terms" style="font-weight: 700;font-size: 20px;">Privacy Policy</p></div>
           </div> 
           <div class="row">
            <div class="col-lg-12"><p class="title-text">Last updated: February 24, 2021 <br><br>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.<br><br> We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p></div>
           </div> 
      ...
      <h1 class="terms-main-t">Interpretation and Definitions</h1>
      <h2 class="terms-sub-t">Interpretation</h2>
      <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
      <h2 class="terms-sub-t">Definitions</h2>
      ...
      <li>
      <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named ToDoSmarter</p>
      </li>
      <li>
      ...
      <li>
      <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to WWW.MEDIA PTY LTD, 14 ELATA COURT WATTLE GROVE NSW 2173.</p>
      ...
      <li>
      <p><strong>Website</strong> refers to ToDoSmarter, accessible from <a href="http://todosmarter.com/" rel="external nofollow noopener" target="_blank">http://todosmarter.com</a></p>
      </li>
      <li>
      ...
      <h1 class="terms-main-t">Collecting and Using Your Personal Data</h1>
      <h2 class="terms-sub-t">Types of Data Collected</h2>
      <h3 style="
          font-size: 21px;
      ">Personal Data</h3>
      ...
      <h3 style="
          font-size: 21px;
      ">Information from Third-Party Social Media Services</h3>
      ...
      <h2 class="terms-sub-t">Use of Your Personal Data</h2>
      ...
      <h2 class="terms-sub-t">Retention of Your Personal Data</h2>
      ...
      <h2 class="terms-sub-t">Transfer of Your Personal Data</h2>
      ...
      <h2 class="terms-sub-t">Disclosure of Your Personal Data</h2>
      <h3 style="
          font-size: 21px;
      ...
      <h2 class="terms-sub-t">Security of Your Personal Data</h2>
      <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
      <h1 class="terms-main-t">Detailed Information on the Processing of Your Personal Data</h1>
      <p>The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process and transfer information about Your activity on Our Service in accordance with their Privacy Policies.</p>
      <h2 class="terms-sub-t">Analytics</h2>
      ...
      <h2 class="terms-sub-t">Advertising</h2>
      ...
      <h2 class="terms-sub-t">Email Marketing</h2>
      ...
      <h2 class="terms-sub-t">Payments</h2>
      ...
      <h1 class="terms-main-t">GDPR Privacy</h1>
      <h2 class="terms-sub-t">Legal Basis for Processing Personal Data under GDPR</h2>
      ...
      <h2 class="terms-sub-t">Your Rights under the GDPR</h2>
      ...
      <h2 class="terms-sub-t">Exercising of Your GDPR Data Protection Rights</h2>
      <p>You may exercise Your rights of access, rectification, cancellation and opposition by contacting Us. Please note that we may ask You to verify Your identity before responding to such requests. If You make a request, We will try our best to respond to You as soon as possible.</p>
      <p>You have the right to complain to a Data Protection Authority about Our collection and use of Your Personal Data. For more information, if You are in the European Economic Area (EEA), please contact Your local data protection authority in the EEA.</p>
      <h1 class="terms-main-t">CCPA Privacy</h1>
      <p>This privacy notice section for California residents supplements the information contained in Our Privacy Policy and it applies solely to all visitors, users, and others who reside in the State of California.</p>
      <h2 class="terms-sub-t">Categories of Personal Information Collected</h2>
      ...
      <h2 class="terms-sub-t">Sources of Personal Information</h2>
      ...
      <h2 class="terms-sub-t">Use of Personal Information for Business Purposes or Commercial Purposes</h2>
      ...
      <h2 class="terms-sub-t">Disclosure of Personal Information for Business Purposes or Commercial Purposes</h2>
      ...
      <h2 class="terms-sub-t">Sale of Personal Information</h2>
      ...
      <h2 class="terms-sub-t">Share of Personal Information</h2>
      ...
      <h2 class="terms-sub-t">Sale of Personal Information of Minors Under 16 Years of Age</h2>
      ...
      <h2 class="terms-sub-t">Your Rights under the CCPA</h2>
      ...
      <h2 class="terms-sub-t">Exercising Your CCPA Data Protection Rights</h2>
      <p>In order to exercise any of Your rights under the CCPA, and if You are a California resident, You can contact Us:</p>
      <ul>
      <li>By email: content@wwwmedia.world</li>
      </ul>
      ...
      <h2 class="terms-sub-t">Do Not Sell My Personal Information</h2>
      ...
      <h1 class="terms-main-t">&quot;Do Not Track&quot; Policy as Required by California Online Privacy Protection Act (CalOPPA)</h1>
      <p>Our Service does not respond to Do Not Track signals.</p>
      <p>However, some third party websites do keep track of Your browsing activities. If You are visiting such websites, You can set Your preferences in Your web browser to inform websites that You do not want to be tracked. You can enable or disable DNT by visiting the preferences or settings page of Your web browser.</p>
      <h1 class="terms-main-t">Children's Privacy</h1>
      ...
      <h1 class="terms-main-t">Your California Privacy Rights (California's Shine the Light law)</h1>
      <p>Under California Civil Code Section 1798 (California's Shine the Light law), California residents with an established business relationship with us can request information once a year about sharing their Personal Data with third parties for the third parties' direct marketing purposes.</p>
      <p>If you'd like to request more information under the California Shine the Light law, and if You are a California resident, You can contact Us using the contact information provided below.</p>
      <h1 class="terms-main-t">California Privacy Rights for Minor Users (California Business and Professions Code Section 22581)</h1>
