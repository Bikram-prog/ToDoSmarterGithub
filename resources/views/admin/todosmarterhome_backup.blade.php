    ...
    <div class="container-lg mt-4">
      <div class="row mb-2">
        ...
        <div class="col-md-6 mt-4" style="">
          <h1 class="fs-2 text-center">Welcome to ToDoSmarter.com</h1>
          <h2 class="fs-2 text-center">Project Planning The Affordable Way </h2>
          <div class="row">
            <div class="col-md-2"></div>
            <div class="col-md-8" style="background: #fff;padding: 25px;
border-radius: 8px;height: 400px;margin-top: 80px;">
