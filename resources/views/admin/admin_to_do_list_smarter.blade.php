...
/* generated by https://loading.io/ */
  ...
  <body>
    ...
    <div class="container-lg mt-4 globalA">
      <div class="row mb-2">
        <div class="col-md-12">
          <h2>Todo List <a href="/u/to_do_smarter_logout" class="btn btn-outline-danger btn-sm"><span style="float: right; cursor: pointer;">Logout</span></a> <span id="theme_chng" style="float: right; cursor: pointer;"><i style="font-size: 22px;" class="fas fa-moon"></i></span></h2>
          <h4>{{ Crypt::decryptString($_COOKIE['UsersCompanyToDoSmarter']) }}</h4>
        </div>
      </div>
      <div class="row mb-2">
        <div class="col-md-8">
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="/u/addtodolistpost-smarter" method="POST" id="addtodo_form2" enctype="multipart/form-data">
          {{ csrf_field() }}
        ...
        <div class="form-group mb-2">
          ...
          <input class="form-control" type="text" id="datepicker" name="trgt_job_todo" placeholder="Days to complete job" autocomplete="off" required>
        </div>
...
<div class="modal fade" id="contact_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  $( function() {
    ...
    function add_reciepent(){
      ...
      $.get("/u/add-reciepent-smarter/"+ name + "/" + email + "/" + psswrd + "/" + status, function(result){
    ...
    function all_reciepent(){
      var vvv = <?php echo Crypt::decryptString($_COOKIE['UserStatusToDoSmarter']); ?>;
      $("a").removeClass("active");
      $("#all_todo").addClass("active");
      $("#contents").html("");
      $("#loading_gl").show();
      $.get("/u/all-reciepent-smarter", function(results){
        results.forEach(function(result) {
            $("#contents").append(`
                ...
                ${vvv == 1 ? `<small style="font-size: 18px;"> <i onclick="delete_rec(${result.reciepent_id});" class="fas fa-trash"></i> </small>` : ''}
                 

                </div>
                <p class="mb-1">${result.reciepent_email} </p>
                <p class="badge bg-success mb-1">${result.reciepent_status == 1 ? 'Admin' : 'Member'} </p>
    ...
    function delete_rec(id) {
      ...
      if(conf) {
        $.get("/u/del-reciepent-smarter/"+ id , function(result){
    ...
    function open_todo(){
      var xxx = <?php echo Crypt::decryptString($_COOKIE['UserStatusToDoSmarter']); ?>;
      $("a").removeClass("active");
      $("#open_todo").addClass("active");
      $("#contents").html("");
      $("#loading_gl").show();
      $.get("/u/opentodo-smarter", function(results){
        results.forEach(function(result) {
          if(result.to_do_list_image != null) {
                var img= "<a href='http://todosmarter.com/images/to_do_smarter_img/"+result.to_do_list_image+"' target='_blank' style='text-decoration:none;'>View Attachment</a>"
              }else{
                var img ="";
              }
            ...
            if(result.to_do_list_notes == null && result.to_do_list_target_days != null) {
              $("#contents").append(`
                ...
                <div class="w-100 justify-content-between">
                 ...
                 ${xxx == 1 ? `<i data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" onclick="delete_todo(${result.to_do_list_id});" class="fas fa-trash"></i>` : ''}</small>
                </div>
                ...
                <p style="color: #f53b57;font-weight: 600;">Deadline: ${result.to_do_list_target_days}</p>
    ...
    function in_prog_todo(){
      var yyy = <?php echo Crypt::decryptString($_COOKIE['UserStatusToDoSmarter']); ?>;
      $("a").removeClass("active");
      $("#in_prog_todo").addClass("active");
      $("#contents").html("");
      $("#loading_gl").show();
      $.get("/u/inprogtodo-smarter", function(results){
        results.forEach(function(result) {
          if(result.to_do_list_image != null) {
                var img= "<a href='http://todosmarter.com/images/to_do_smarter_img/"+result.to_do_list_image+"' target='_blank' style='text-decoration:none;'>View Attachment</a>"
              }else{
            ...
            if(result.to_do_list_notes == null && result.to_do_list_target_days != null) {
              $("#contents").append(`
                ...
                <div class="w-100 justify-content-between">
                 ...
                 <i data-bs-toggle="tooltip" data-bs-placement="top" title="Delay" onclick="delay_prog_todo_action(${result.to_do_list_id});"  class="far fa-clock" style="color: #eb4d4b;"></i> &nbsp;&nbsp;
                 <i data-bs-toggle="tooltip" data-bs-placement="top" title="Completed" onclick="complete_todo_action(${result.to_do_list_id});"  class="far fa-check-circle" style="color: #6ab04c;"></i> &nbsp;&nbsp; 
                 ${yyy == 1 ? `<i data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" onclick="delete_todo(${result.to_do_list_id});" class="fas fa-trash"></i>` : ''}</small>
                </div>
    ...
    function delay_todo(){
      var zzz = <?php echo Crypt::decryptString($_COOKIE['UserStatusToDoSmarter']); ?>;
      $("a").removeClass("active");
      $("#delay_todo").addClass("active");
      $("#contents").html("");
      $("#loading_gl").show();
      $.get("/u/delaytodo-smarter", function(results){
        results.forEach(function(result) {
          if(result.to_do_list_image != null) {
                var img= "<a href='http://todosmarter.com/images/to_do_smarter_img/"+result.to_do_list_image+"' target='_blank' style='text-decoration:none;'>View Attachment</a>"
              }else{
            ...
            if(result.to_do_list_notes == null && result.to_do_list_target_days != null) {
              $("#contents").append(`
                ...
                <div class="w-100 justify-content-between">
                 ...
                 <small style="font-size: 20px;"> ${moment(result.to_do_list_datetime).fromNow()}&nbsp;&nbsp;
                 <i data-bs-toggle="tooltip" data-bs-placement="top" title="Completed" onclick="complete_todo_action(${result.to_do_list_id});"  class="far fa-check-circle" style="color: #6ab04c;"></i> &nbsp;&nbsp; 
                 ${zzz == 1 ? `<i data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" onclick="delete_todo(${result.to_do_list_id});" class="fas fa-trash"></i>` : ''}</small>
                </div>
    ...
    function delete_todo(id) {
      var conf = confirm("Are you sure?");
      if(conf) {
        $.get("/u/del-todo-smarter/"+ id , function(result){
    ...
    function edit_todo_action(id) {
      var conf = confirm("Are you sure?");
      if(conf) {
        window.location.href= '/u/edit-to-do-list-smarter/' +id
      } else {
        return false;
      }
    ...
    function in_prog_todo_action(id) {
      var conf = confirm("Are you sure?");
      if(conf) {
        $.get("/u/in-prog-todo-smarter/"+ id , function(result){
    ...
    function delay_prog_todo_action(id) {
      var conf = confirm("Are you sure?");
      if(conf) {
        $.get("/u/delay-todo-smarter/"+ id , function(result){
    ...
    function complete_todo_action(id) {
      var conf = confirm("Are you sure?");
      if(conf) {
        $.get("/u/complete-todo-smarter/"+ id , function(result){
    ...
    function complete_todo(){
      ...
      $("#contents").html("");
      $("#loading_gl").show();
      $.get("/u/completetodo-smarter", function(results){
        results.forEach(function(result) {
          if(result.to_do_list_image != null) {
                var img= "<a href='http://todosmarter.com/images/to_do_smarter_img/"+result.to_do_list_image+"' target='_blank' style='text-decoration:none;'>View Attachment</a>"
              }else{
