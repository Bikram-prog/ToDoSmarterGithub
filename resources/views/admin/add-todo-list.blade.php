  ...
  <div>
    <div>
      ...
      <div class="modal-body">
        ...
        <form action="/u/addtodolistpost-smarter" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}

        <div class="form-group mb-2">
          <!-- <label>Select Date*</label> -->
          <input class="form-control" type="hidden" name="datetime_todo" placeholder="Select date" autocomplete="off" value="{{ $date }}" readonly>
        </div>
        ...
        <div class="form-group mb-2">
          <label>Notes*</label>
          <textarea class="form-control" rows="6" name="notes_todo" placeholder="Write the description..."></textarea>
        </div>
        ...
        <!-- <div class="alert alert-primary mb-2">
          You can drag files into the "no files choosen" box as well as manually choosing a file.
        </div> -->

        <div class="form-group">
          <input type="hidden" class="form-control" name="image" multiple>
        </div>

        <!-- <div class="alert alert-danger mb-2">
          Please be aware that once you have added your files into the "Project Creation Page",<br>You can't add files after you have posted the project,not even in edit mode.
        </div> -->
        ...
        <div class="form-check form-check-inline">
          ...
          @if($da->reciepent_pro_pic_path != '')
              <img style="width: 30px; height: 30px; border-radius: 50px;" src="{{ $da->reciepent_pro_pic_path }}" class="img-fluid">
              @else
              <img style="width: 30px; height: 30px; border-radius: 50px;border: 1px solid #ccc;" src="https://todosmarter.com/images/male-user-placeholder.png" class="img-fluid">
              @endif
        ...
        <div class="alert alert-danger mt-3">
          This "Add Project" page is in 2 stages,once you input all info on this page and press next,it will then take you to the File attachment page for posting.
        </div>
