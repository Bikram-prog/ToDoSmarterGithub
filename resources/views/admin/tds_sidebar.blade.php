...
<html lang="en">
  <head>
    ...
    @if(Request::is('u/add-receiepent') == false)
    <link href="{{asset('css/components.min.css')}}" rel="stylesheet" type="text/css">
    @endif

    <meta name="csrf-token" content="{{ csrf_token() }}" />

    @if(Request::is('u/add-receiepent') == true)
  ...
  <body>
    ...
    <div class="container-fluid mt-4">
      <div class="row mb-2">
        ...
        <a href="/u/add-to-list" class="btn btn-warning fw-bold mt-4" style="width: 100%">Add Project</a>
        @endif
        <input type="file" style="display: none;" class="image" name="photo" id="p_pic">
        <a onclick="openFile()" href="javascript::void(0)" class="btn btn-danger fw-bold mt-4" style="width: 100%;">Upload Profile Image</a>

        <a href="/u/monthlybreakdown" class="btn btn-primary fw-bold mt-4" style="width: 100%">Monthly Breakdown</a>

        <a class="btn btn-primary fw-bold mt-4" style="width: 100%;background-color: #9b59b6;"  onclick="snd_modal()">ToDoSmarter Tutorial</a>
